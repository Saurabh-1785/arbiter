...
# Dashboard: React build output at frontend/dist/
_PROJECT_ROOT = Path(__file__).parent.parent.parent
DASHBOARD_DIR = _PROJECT_ROOT / "frontend" / "dist"
...
def create_app() -> FastAPI:
    ...
    async def dashboard():
        ...
        return HTMLResponse(
            ...
            "<p>Dashboard not built. Run: <code>cd frontend && npm install && npm run build</code></p>"
        )
    ...
    if DASHBOARD_DIR.exists():
        ...
        # Mount the root dashboard dir for legacy compat and direct file access
